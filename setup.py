...
if scratchSetup:
    ...
    try:
        ...
        while True:
            device = input('\033[1;34mWhat device are you on?\n1) mobile\n2) desktop/laptop etc\n3) others like hosts etc\n(answer with 1,2,3.):\n\033[m').lower()
            if device in ["1", "2", "3"]:
                if device == "1":
                    # Termux
                    ...
                    # desktop
                    if device == "3":
                        print('\033[1;36m[0]since your on an unknown device not sure if this will work. still attempting.')
            ...
            while True:
                ...
                if o in ["c", "s"]:
                    if o == "s":
                        ...
                        print("\033[1;36m[0]Continuing the installation process...\033[m")
                        break
                else:
                    print("\033[1;33m[!]Please enter 'c' for continue or 's' for stop.\033[m")
    except Exception as e:
